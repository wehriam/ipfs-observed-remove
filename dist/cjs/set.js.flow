...
export default class IpfsObservedRemoveSet<V> extends ObservedRemoveSet<V> { // eslint-disable-line no-unused-vars
  /**
   ...
   */
  constructor(ipfs:Object, topic:string, entries?: Iterable<V>, options?:Options = {}) {
