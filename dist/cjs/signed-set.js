...
class IpfsSignedObservedRemoveSet extends _observedRemove.SignedObservedRemoveSet {
  ...
  async initIpfs() {
    ...
    try {
      const promises = [this.ipfs.pubsub.subscribe(this.topic, this.boundHandleQueueMessage, {
        discover: true,
        signal: this.abortController.signal
      })];

      if (!this.disableSync) {
        promises.push(this.ipfs.pubsub.subscribe(`${this.topic}:hash`, this.boundHandleHashMessage, {
          discover: true,
          signal: this.abortController.signal
        }));
...
exports.default = IpfsSignedObservedRemoveSet;
